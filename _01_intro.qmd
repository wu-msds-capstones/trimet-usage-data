...
For clarity throughout this report, we will use the term "station" to refer to any stop along a route. For the purposes of this analysis, a route is defined as a series of stations going a specific direction on a specific day. For example, a series of stations running on a weekday is considered a different route from the same series of stations running the same direction on the weekend.